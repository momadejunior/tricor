export default function Faqs(){
    return(
        ...
        <section class="faq-page-area rel z-1 pt-120 pb-115">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-9">
                        <div class="section-title text-center mb-50 wow fadeInUp delay-0-2s">
                            <span class="sub-title mb-10">Asked Questions</span>
                            <h2>Have Any Question For Printing Services! Let’s Knows</h2>
                        </div>
                    </div>
                </div>
                <div class="accordion" id="faq-accordion">
                    <div class="row">
                        <div class="col-lg-6 mb-15 wow fadeInUp delay-0-2s">
                            <div class="accordion-item style-two">
                        ...
                        <div class="col-lg-6 mb-15 wow fadeInUp delay-0-4s">
                            <div class="accordion-item style-two">
                                <h2 class="accordion-header">
        ...
        <div class="faq-page-video wow fadeInUp delay-0-2s">
            <div class="container">
        ...
        <section class="printing-solutions-area pt-120 pb-130">
            <div class="container">
                <div class="row large-gap align-items-center">
                    <div class="col-lg-6">
                        <div class="printing-solutions-image rel z-1 rmb-55 wow fadeInLeft delay-0-2s">
                            <img src="assets/images/about/printing-solutions.png" alt="Printing Solutions"/>
                    ...
                    <div class="col-lg-6">
                        <div class="printing-solutions-content wow fadeInRight delay-0-2s">
                            <div class="section-title mb-30">
                                <span class="sub-title mb-5">Printing Solutions</span>
                                <h2>We Help To Improve Your Printing Solutions</h2>
                            </div>
                            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupte quos dolores et quas molestias excepturi sint occaecati cuidy tate provident similique culpa officia deserunt</p>
                            <ul class="list-style-one pt-5">
                                <li>Quality Services Provider</li>
                                <li>Printing, Designing and Transportation</li>
                            </ul>
                            <a href="about.html" class="theme-btn mt-35">Learn More Us <i class="far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="faq-contact-form-area mb-130 wow fadeInUp delay-0-2s">
            <div class="container">
                <form id="faq-contact-form" class="faq-contact-form z-1 rel" name="faq-contact-form" action="#" method="post">
                   <div class="section-title text-center mb-40">
                    ...
                    <div class="row mt-25">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea name="message" id="message" class="form-control" rows="4" placeholder="Write a Comments" required=""/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group text-center mb-0">
                                <button type="submit" class="theme-btn">Send Your Message <i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
